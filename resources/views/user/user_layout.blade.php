...
<html lang="en">
    ...
    <body id="page-top" class="index" style="background-color:#eee">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right" style="text-align:right">
                        <li class="hidden">
                            <a href="user_welcome"></a>
                        </li>
                        <li>
                            <a class="page-scroll" href="user_welcome">Home</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="user_guitars">Guitars</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="user_favorites">Favorites</a>
                        </li>
        ...
        <script src="jquery/favorite.js"></script>
